...
const ProgressBar = ({ progressContent, currentProgress, maxProgress }) => {
    ...
    return (
        <ProgressContainer>
            ...
            <BarContent>
                <ProgressSubText className='caption-sm-200'>{progressContent}</ProgressSubText>
                <CurrentProgress className='caption-md-300'>{currentProgress}/{maxProgress}</CurrentProgress>
            </BarContent>
